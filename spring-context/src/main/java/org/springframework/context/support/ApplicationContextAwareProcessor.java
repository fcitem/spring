...
/**BeanPostProcessor接口的实现,将ApplicationContext传递给实现EnvironmentAware,EmbeddedValueResolverAware,ResourceLoaderAware,ApplicationEventPublisherAware等接口的bean<br>
